	...
	function TabFunction:MakeTab(TabConfig)
		...
		AddConnection(TabFrame.MouseButton1Click, function()
			for _, Tab in next, TabHolder:GetChildren() do
				if Tab:IsA("TextButton") then
					...
					TweenService:Create(Tab.Ico, TweenInfo.new(0.22, Enum.EasingStyle.Quint), {ImageTransparency = 0.5}):Play()
					TweenService:Create(Tab.Title, TweenInfo.new(0.22, Enum.EasingStyle.Quint), {TextTransparency = 0.5}):Play()
				end
			end
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				local ButtonFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					AddThemeObject(SetProps(MakeElement("Label", ButtonConfig.Name, 12), {
						Size = UDim2.new(1, -12, 1, 0),
						Position = UDim2.new(0, 12, 0, 0),
						Font = Enum.Font.GothamSemibold,
						Name = "Content"
				...
				AddConnection(Click.MouseEnter, function()
					local S = GetSecond()
					TweenService:Create(ButtonFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quint), {
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				local ToggleFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					AddThemeObject(SetProps(MakeElement("Label", ToggleConfig.Name, 12), {
						Size = UDim2.new(1, -12, 1, 0),
						Position = UDim2.new(0, 12, 0, 0),
						Font = Enum.Font.GothamSemibold,
						Name = "Content"
				...
				function Toggle:Set(Value)
					Toggle.Value = Value
					local Theme = OrionLib.Themes[OrionLib.SelectedTheme]
					TweenService:Create(ToggleBox, TweenInfo.new(0.2, Enum.EasingStyle.Quint), {
						BackgroundColor3 = Toggle.Value and ToggleConfig.Color or Theme.Divider
					}):Play()
					TweenService:Create(ToggleBox.Stroke, TweenInfo.new(0.2, Enum.EasingStyle.Quint), {
						Color = Toggle.Value and ToggleConfig.Color or Theme.Stroke
					}):Play()
					TweenService:Create(ToggleBox.Ico, TweenInfo.new(0.2, Enum.EasingStyle.Quint), {
						ImageTransparency = Toggle.Value and 0 or 1,
						Size = Toggle.Value and UDim2.new(0, 14, 0, 14) or UDim2.new(0, 6, 0, 6)
					}):Play()
				...
				AddConnection(Click.MouseEnter, function()
					local S = GetSecond()
					TweenService:Create(ToggleFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quint), {
						BackgroundColor3 = Color3.fromRGB(S.R * 255 + 5, S.G * 255 + 5, S.B * 255 + 5)
					}):Play()
				end)
			...
			function ElementFunction:AddSlider(SliderConfig)
				...
				local SliderDrag = SetChildren(SetProps(MakeElement("RoundFrame", SliderConfig.Color, 0, 4), {
					...
					AddThemeObject(SetProps(MakeElement("Label", "value", 11), {
				...
				local SliderBar = SetChildren(SetProps(MakeElement("RoundFrame", SliderConfig.Color, 0, 4), {
				...
				local SliderFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					AddThemeObject(SetProps(MakeElement("Label", SliderConfig.Name, 12), {
						Size = UDim2.new(1, -12, 0, 14),
						Position = UDim2.new(0, 12, 0, 6),
						Font = Enum.Font.GothamSemibold,
						Name = "Content"
				...
				local function UpdateVisual(Value, Instant)
					...
					if Instant then
						...
						TweenService:Create(SliderDrag, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {
			...
			function ElementFunction:AddDropdown(DropdownConfig)
				...
				local DropdownFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					SetProps(SetChildren(MakeElement("TFrame"), {
						AddThemeObject(SetProps(MakeElement("Label", DropdownConfig.Name, 12), {
							Size = UDim2.new(1, -12, 1, 0),
							Position = UDim2.new(0, 12, 0, 0),
							Font = Enum.Font.GothamSemibold,
							Name = "Content"
						...
						AddThemeObject(SetProps(MakeElement("Label", "Selected", 11), {
				...
				local function AddOptions(Options)
					for _, Option in pairs(Options) do
						local OptionBtn = AddThemeObject(SetProps(SetChildren(MakeElement("Button"), {
							...
							AddThemeObject(SetProps(MakeElement("Label", Option, 11, 0.4), {
				...
				function Dropdown:Set(Value)
					if not table.find(Dropdown.Options, Value) then
						...
						for _, v in pairs(Dropdown.Buttons) do
							TweenService:Create(v, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {BackgroundTransparency = 1}):Play()
							TweenService:Create(v.Title, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {TextTransparency = 0.4}):Play()
						end
						return
					end
					...
					TweenService:Create(Dropdown.Buttons[Value], TweenInfo.new(0.1, Enum.EasingStyle.Quad), {BackgroundTransparency = 0}):Play()
					TweenService:Create(Dropdown.Buttons[Value].Title, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {TextTransparency = 0}):Play()
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					if #Dropdown.Options > MaxElements then
						TweenService:Create(DropdownFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quad), {
							Size = Dropdown.Toggled and UDim2.new(1, 0, 0, 32 + (MaxElements * 24)) or UDim2.new(1, 0, 0, 32)
						}):Play()
					else
						TweenService:Create(DropdownFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quad), {
							Size = Dropdown.Toggled and UDim2.new(1, 0, 0, DropdownList.AbsoluteContentSize.Y + 32) or UDim2.new(1, 0, 0, 32)
						}):Play()
					end
				end)
			...
			function ElementFunction:AddTextbox(TextboxConfig)
				...
				local TextboxFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					AddThemeObject(SetProps(MakeElement("Label", TextboxConfig.Name, 12), {
						Size = UDim2.new(1, -12, 1, 0),
						Position = UDim2.new(0, 12, 0, 0),
						Font = Enum.Font.GothamSemibold,
						Name = "Content"
			...
			function ElementFunction:AddColorpicker(ColorpickerConfig)
				...
				local ColorpickerFrame = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 5), {
					...
					SetProps(SetChildren(MakeElement("TFrame"), {
						AddThemeObject(SetProps(MakeElement("Label", ColorpickerConfig.Name, 12), {
							Size = UDim2.new(1, -12, 1, 0),
							Position = UDim2.new(0, 12, 0, 0),
							Font = Enum.Font.GothamSemibold,
							Name = "Content"
				...
				AddConnection(Click.MouseButton1Click, function()
					...
					TweenService:Create(ColorpickerFrame, TweenInfo.new(0.15, Enum.EasingStyle.Quad), {
						Size = Colorpicker.Toggled and UDim2.new(1, 0, 0, 140) or UDim2.new(1, 0, 0, 32)
					}):Play()
		...
		function ElementFunction:AddSection(SectionConfig)
			...
			AddConnection(SectionFrame.Holder.UIListLayout:GetPropertyChangedSignal("AbsoluteContentSize"), function()
				SectionFrame.Size = UDim2.new(1, 0, 0, SectionFrame.Holder.UIListLayout.AbsoluteContentSize.Y + 24)
